...
FloatingWindow {
    ...
    function setAsWallpaper(path){
        if(!path) return
        Quickshell.execDetached(["sh","-c","/home/khojah/.local/bin/set-wallpaper '"+path.replace(/'/g,"'\\''")+"' & disown"])
    }
            ...
            GridView {
                ...
                delegate: Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: { grid.currentIndex = index; root.openPreview(index) }
            ...
            GridView {
                ...
                delegate: Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: { localGrid.currentIndex = index; root.setAsWallpaper(modelData.path) }
                        onDoubleClicked: Quickshell.execDetached(["xdg-open", modelData.path])
                    }
                    Rectangle {
                        z: 10
