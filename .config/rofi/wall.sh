...
WALL_DIR="/home/khojah/dotfiles/wallpapers"
[[ -d "$WALL_DIR" ]] || WALL_DIR="/home/khojah/.config/omarchy/themes/snow_black/backgrounds"
[[ -d "$WALL_DIR" ]] || WALL_DIR="$HOME/.config/theme/current"
THUMB_DIR="/tmp/wall_thumbs"
LOOKUP_FILE="/tmp/wall_lookup.json"
SCRIPT_PATH="/home/khojah/.config/rofi/wall.sh"
selected="$1"
...
if [[ -n "$selected" ]]; then
    ...
    nohup /home/khojah/.local/bin/set-wallpaper "$full_path" >/dev/null 2>&1 &
    ...
    rofi -show wallpaper -modes "wallpaper:$SCRIPT_PATH" -p '🖼  Wallpaper' -show-icons \
        -theme /home/khojah/.config/rofi/wallpaper.rasi \
