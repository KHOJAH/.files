...
WlSessionLock {
    ...
    WlSessionLockSurface {
        ...
        Rectangle {
            ...
            Image {
                anchors.fill: parent
                source: "file:///home/khojah/.config/theme/current/background"
            ...
            RowLayout {
                ...
                Text {
                    ...
                    Timer {
                        ...
                        onTriggered: {
                            ...
                            xhr.open("GET","file:///home/khojah/.config/hypr/scripts/battery.sh",false)
                ...
                Text {
                    ...
                    Timer {
                        ...
                        onTriggered: {
                            var xhr=new XMLHttpRequest()
                            xhr.open("GET","file:///home/khojah/.config/hypr/scripts/sysinfo.sh",false)
